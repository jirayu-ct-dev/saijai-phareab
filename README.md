...
ที่หน้า POS เปิดแท็บ **ลงรายการย้อนหลัง** แล้วเลือกประเภทรายการ: รับผ้าหน้าร้าน หรือ ขายแพ็กเกจ

สำหรับรับผ้า ระบุวันและเวลารับผ้าจริง (เวลาไทย), สถานะปัจจุบัน และวันเสร็จจริงหากงานเสร็จแล้ว
หากรับเงินแล้วให้ระบุวันที่รับเงินจริงและวิธีชำระเงิน จากนั้นบันทึกครั้งเดียว
ไม่ต้องเปลี่ยนสถานะย้อนหลังทีละขั้น
วันและเวลารับเงินจริงเริ่มต้นตามวันและเวลารับผ้าจริง และปุ่มนัดรับวันพุธ/เสาร์คำนวณจากวันที่ดังกล่าว

สำหรับขายแพ็กเกจ ระบุวันและเวลาขายจริง และถ้าชำระแล้วให้ระบุวันที่ชำระเงินจริงและวิธีชำระเงิน
(วันและเวลาชำระเริ่มต้นตามวันขายจริง และค่าเริ่มต้นเป็นโอนเงิน) ทั้งสองแท็บเลือกลูกค้าเดิมจากการค้นหาหรือเพิ่มลูกค้าใหม่ได้เหมือนกัน
ลูกค้าใหม่จะได้ลิงก์เปิดใช้บัญชีหลังบันทึกสำเร็จ ระบบตั้งช่วงสิทธิ์แพ็กเกจนับจากวันขายจริง
(หมดอายุตามจำนวนวันของแพ็กเกจ) และบันทึกรายได้ตามวันชำระเงินจริง การขายที่ยังไม่ชำระ
จะได้สิทธิ์แบบรอเปิดใช้งานเหมือนการขายปกติ

ระบบไม่ส่ง LINE แจ้งเตือนตอนสร้างรายการย้อนหลัง และไม่เปลี่ยนสถานะที่เลือกอัตโนมัติ
วันรับผ้า/วันขายและวันรับเงินจริงใช้ในรายงานงานและรายรับ ส่วนเวลาคีย์ ผู้บันทึก และเลขเอกสาร
อิงการบันทึกปัจจุบัน หน้ารายละเอียดแสดงเครื่องหมายลงรายการย้อนหลังพร้อมเวลาบันทึก
ห้ามระบุวันอนาคต วันเสร็จ/วันรับเงิน/วันนัดรับต้องไม่ก่อนวันรับผ้า และวันรับเงินต้องไม่ก่อนวันขายแพ็กเกจ
...
บริการราคาหน้าร้านกับบริการของแพ็กเกจเป็นคนละแค็ตตาล็อก: ราคาและงานหน้าร้านผูกกับบริการ/ราคาหน้าร้าน
ส่วนบริการแพ็กเกจมีรายการผ้าที่รวมเครดิตของตัวเอง จึงแก้รายการแพ็กเกจได้โดยไม่เปลี่ยนราคาหน้าร้าน
เมื่อเลือกแพ็กเกจใน POS จะแสดงผ้าที่รวมในแพ็กเกจก่อน พนักงานเพิ่มผ้าอื่นจากบริการราคาหน้าร้านใดก็ได้
ได้ โดยรายการเพิ่มมาคิดเงินเป็นค่าเริ่มต้นและเลือกยกเว้นราคาได้ รายการที่ยกเว้นยังอยู่นอกแพ็กเกจ
และไม่ตัดเครดิต เอกสารแจ้งราคา ใบเสร็จ ประวัติออเดอร์ และ LINE แยกสถานะทั้งสามแบบนี้
ออเดอร์ที่ยอดชำระเป็นศูนย์จะถูกปิดยอดและออกใบเสร็จโดยไม่สร้างยอดค้างชำระ
แพ็กเกจบริการรับ-ส่งเป็นสิทธิ์แบบไม่ใช้เครดิต: ออเดอร์บันทึกเพียงว่ามีการใช้บริการรับ-ส่ง
จำนวนไม้แขวนที่ลูกค้าให้มาบันทึกเป็นข้อมูลโดยไม่คิดเงิน ส่วนไม้แขวนที่ซื้อเพิ่มคิดชิ้นละ 10 บาท
