...
<template>
  <section class="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-125 bg-primary-400/10 dark:bg-primary-500/15 rounded-full blur-[120px] pointer-events-none" />
