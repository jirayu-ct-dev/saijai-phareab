...
const sections: Section[] = [
  {
    ...
    icon: "i-lucide-shirt",
    paragraphs: [
      "หน้า POS รับผ้าใช้ที่เมนู 'รับผ้า → หน้าร้าน' หรือ /admin/service-orders",
      {
        type: "step",
        items: [
          "เลือกลูกค้า (หรือกด 'ลูกค้าหน้าร้าน' ถ้าเป็น walk-in)",
          "เลือกบริการ + จำนวนชิ้น จากตาราง catalog",
          "ถ่ายรูปผ้า (ถ้ามีผ้าชำรุดให้ติ๊ก 'ผ้าชำรุด' ในรูปนั้น)",
          "ระบุจำนวนไม้แขวนที่ขาด (ถ้ามี)",
          "ระบุวันนัดรับผ้า",
          "เลือกช่องทางชำระเงิน (เงินสด = ยืนยันทันที, โอน = อัปโหลดสลิป)",
          "กดบันทึก ระบบจะส่งใบเสร็จและการแจ้งเตือนไปยังลูกค้าทาง LINE",
        ],
      },
      {
        type: "note",
        text: "ลูกค้าที่ผูก LINE จะได้รับ flex message พร้อมรูปผ้าและรายละเอียดออเดอร์",
      },
    ],
  },
  {
    ...
    paragraphs: [
      "เมนู 'รับผ้า → ขายแพ็กเกจ' สำหรับขายแพ็กเกจหลัก/เสริมให้ลูกค้า",
      {
        ...
        items: [
          ...
          "เลือกแพ็กเกจ + จำนวน",
          "เลือกช่องทางชำระ (เงินสด/โอน)",
          "ถ้าเลือก 'โอน' ต้องอัปโหลดสลิป",
          "กดบันทึก ระบบสร้าง MemberEntitlement พร้อมเครดิตเริ่มต้น",
        ],
      },
      {
        type: "note",
    ...
    paragraphs: [
      {
        ...
        items: [
          ...
          "ตั้งค่าธุรกิจ — ค่าไม้แขวน, VAT, prefix เลขเอกสาร",
          "Export ข้อมูล — ดาวน์โหลดรายงานเป็น CSV",
