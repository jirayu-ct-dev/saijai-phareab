...
const quickLinks = computed<QuickLink[]>(() => [
  ...
  },
  {
    ...
    icon: "i-lucide-tags",
    to: "/me/pricing",
    description: "ตรวจราคาซักพับและราคาซักแยกชิ้นใน sidebar",
  },
  ...(isMember.value ? [{
    label: "แพ็กเกจของฉัน",
    icon: "i-lucide-package-check",
    to: "/me/membership",
    description: "ดูเครดิตคงเหลือ วันหมดอายุ และประวัติการใช้เครดิต",
  }] : []),
  {
    label: "แพ็กเกจบริการ",
    icon: "i-lucide-package",
    to: "/packages",
    description: "ดูแพ็กเกจที่ร้านเปิดให้บริการและติดต่อผ่าน LINE",
  },
  {
    label: "ตั้งค่า",
...
const sections: Section[] = [
    ...
    paragraphs: [
      {
        ...
        items: [
          ...
          "ดูแพ็กเกจที่กำลังใช้งาน เครดิตคงเหลือ หลอดเครดิต และวันหมดอายุ",
  ...
  },
  {
    ...
    icon: "i-lucide-tags",
    to: "/me/pricing",
    description: "เมนูใน sidebar สำหรับตรวจราคาก่อนส่งผ้า",
    paragraphs: [
      {
        type: "list",
        items: [
          "ดูราคาบริการซักพับแบบคิดตามกิโล",
          "ดูราคาซักแยกชิ้น แยกตามชนิดผ้าและบริการ",
          "ใช้ช่องค้นหา ตัวกรองประเภทผ้า และตัวกรองบริการเพื่อหารายการที่ต้องการ",
          "ราคาหน้าร้านใช้กับลูกค้าทั่วไป หรือรายการที่แพ็กเกจไม่ครอบคลุม",
          "ถ้ามีแพ็กเกจอยู่แล้ว ให้เทียบว่ารายการนั้นอยู่ในสิทธิ์แพ็กเกจหรือไม่ก่อนส่งผ้า",
        ],
      },
    ],
  },
    ...
    paragraphs: [
      {
        ...
        items: [
          ...
          "ค้นหาหรือกรองประเภทการขาย เช่น แพ็กเกจ หรือรายการผ้า",
  ...
  {
    id: "packages",
    title: "ดูแพ็กเกจบริการ",
    icon: "i-lucide-package-plus",
    to: "/packages",
    description: "หน้าแสดงแพ็กเกจที่ร้านเปิดให้บริการ ใช้ดูรายละเอียดก่อนติดต่อร้าน",
    paragraphs: [
      {
        type: "list",
        items: [
          ...
          "หน้านี้เป็นหน้าสาธารณะ ไม่ได้อยู่ใน sidebar ของฉันโดยตรง แต่กดดูได้จากปุ่มในหน้าแดชบอร์ด ราคา หรือคู่มือนี้",
    ...
    paragraphs: [
      {
        type: "list",
        items: [
          "ดูแพ็กเกจที่กำลังใช้งาน เครดิตเริ่มต้น เครดิตคงเหลือ หลอดเครดิต และวันหมดอายุ",
      ...
      {
        type: "note",
        text: "เมนูนี้จะแสดงเฉพาะลูกค้าที่มีสถานะสมาชิกแพ็กเกจ ถ้ายังไม่มีแพ็กเกจให้ดูรายละเอียดที่หน้าแพ็กเกจบริการแล้วติดต่อร้านผ่าน LINE",
      },
    ],
  },
  {
        ...
        <div class="mx-auto flex w-full max-w-3xl flex-col gap-3 p-2 sm:p-6">
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="min-w-0">
                ...
                <p class="mt-1 text-sm text-muted">
                  รวมวิธีใช้งานเมนูของฉัน ตั้งแต่ดูออเดอร์ ตรวจราคาหน้าร้าน ดูประวัติชำระเงิน จัดการแพ็กเกจ ไปจนถึงตั้งค่าบัญชี
                </p>
              </div>
            </div>
          </section>
          ...
          <section class="flex flex-col gap-1">
            <div class="-mx-2 border border-default/30 bg-default p-4 dark:border-default/20 dark:bg-elevated/55 sm:mx-0 sm:rounded-lg">
              <p class="font-semibold text-highlighted">ทางลัดที่ใช้งานบ่อย</p>
              <p class="mt-1 text-sm text-muted">รวมเมนูใน sidebar และหน้าสำคัญที่เกี่ยวกับการใช้บริการ</p>
            </div>
