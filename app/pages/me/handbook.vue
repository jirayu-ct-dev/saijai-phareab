...
const sections: Section[] = [
    ...
    paragraphs: [
      {
        ...
        items: [
          ...
          "ดูรายการชำระเงินล่าสุดและออเดอร์ล่าสุด",
        ],
      },
      {
        type: "note",
  ...
  {
    id: "payment",
    title: "รายการชำระเงิน ใบแจ้งราคา และใบเสร็จ",
    icon: "i-lucide-receipt",
    to: "/me/payment",
    ...
    paragraphs: [
      {
        type: "step",
        items: [
          "เปิดเมนู 'รายการชำระเงิน'",
          "ค้นหาหรือกรองประเภทการขาย เช่น แพ็กเกจ งานซักรีด หรือรายเดือน",
          "กดรายการเพื่อดูรายละเอียดการชำระเงิน",
          "เปิดใบแจ้งราคา หรือใบเสร็จจากปุ่มในหน้ารายละเอียด",
        ],
      },
      {
        type: "note",
        text: "หน้านี้จะแสดงเฉพาะประวัติการชำระเงินของบัญชีที่กำลังใช้งานอยู่เท่านั้น คุณจึงไม่เห็นรายการของลูกค้าคนอื่น",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        type: "note",
        text: "ให้ตรวจที่เมนูรายการชำระเงิน หากเพิ่งทำรายการกับร้าน ให้กดรีเฟรชหรือรอสักครู่เพื่อให้ระบบอัปเดต",
      },
